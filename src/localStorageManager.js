  ...
  const loadFromLocalData = () => {
    if (localStorage.ProjectListSession) {
      ...
      for (let i in importedLocalStorage) {
        ...
        ProjectListManager.getProjectList()[
          selectedProjectIndex
        ].setProjectComplete(importedLocalStorage[i]["complete"]);
        // check tasks
        for (let j in importedLocalStorage[i]["tasks"]) {
          ...
          ProjectListManager.getProjectList()
            ...
            [selectedtaskIndex].setTaskComplete(
  ...
  const saveToLocalData = () => {
    ...
    if (ProjectListManager.getProjectList()) {
      for (let i = 0; i < ProjectListManager.getProjectList().length; i++) {
        ...
        outputObject[ProjectListManager.getProjectList()[i].getProjectName()][
          "description"
        ] = ProjectListManager.getProjectList()[i].getProjectDescription();
        outputObject[ProjectListManager.getProjectList()[i].getProjectName()][
          "date"
        ] = ProjectListManager.getProjectList()[i].getProjectDate();
        outputObject[ProjectListManager.getProjectList()[i].getProjectName()][
          "priority"
        ] = ProjectListManager.getProjectList()[i].getProjectPriority();
        outputObject[ProjectListManager.getProjectList()[i].getProjectName()][
          "complete"
        ] = ProjectListManager.getProjectList()[i].getProjectComplete();
        outputObject[ProjectListManager.getProjectList()[i].getProjectName()][
          "tasks"
        ] = {};
        ...
        if (ProjectListManager.getProjectList()[i].getProjectTasks()) {
          for (
            let j = 0;
            j < ProjectListManager.getProjectList()[i].getProjectTasks().length;
            j++
          ) {
            outputObject[
            ...
            outputObject[
              ...
              ProjectListManager.getProjectList()
                [i].getProjectTasks()
                [j].getTaskName()
            ]["description"] = ProjectListManager.getProjectList()
              [i].getProjectTasks()
              [j].getTaskDescription();
            outputObject[
              ProjectListManager.getProjectList()[i].getProjectName()
            ]["tasks"][
              ProjectListManager.getProjectList()
                [i].getProjectTasks()
                [j].getTaskName()
            ]["date"] = ProjectListManager.getProjectList()
              [i].getProjectTasks()
              [j].getTaskDate();
            outputObject[
              ProjectListManager.getProjectList()[i].getProjectName()
              ...
              ProjectListManager.getProjectList()
                [i].getProjectTasks()
                [j].getTaskName()
            ]["priority"] = ProjectListManager.getProjectList()
              [i].getProjectTasks()
              [j].getTaskPriority();
            outputObject[
              ProjectListManager.getProjectList()[i].getProjectName()
              ...
              ProjectListManager.getProjectList()
                [i].getProjectTasks()
                [j].getTaskName()
            ]["complete"] = ProjectListManager.getProjectList()
              [i].getProjectTasks()
              [j].getTaskComplete();
          }
        }
