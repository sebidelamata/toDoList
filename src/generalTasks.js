...
const GeneralTask = () => {
  ...
  let selectedProjectName =
    ProjectListManager.getProjectList()[selectedProjectIndex].getProjectName();

  let bodyDiv = document.querySelector("#body");

  if (
    bodyDiv.childNodes.length !== undefined &&
    bodyDiv.childNodes.length > 0
  ) {
  ...
  projectPriority.textContent =
    ProjectListManager.getProjectList()[
      selectedProjectIndex
    ].getProjectDate() !== null &&
    ProjectListManager.getProjectList()[
      selectedProjectIndex
    ].getProjectDate() !== ""
      ? `A ${ProjectListManager.getProjectList()[
          selectedProjectIndex
        ].getProjectPriority()} Priority Project Due on ${ProjectListManager.getProjectList()[
          selectedProjectIndex
        ].getProjectDate()}`
      : `A ${ProjectListManager.getProjectList()[
          selectedProjectIndex
        ].getProjectPriority()} Priority Project`;
  ...
  projectComplete.innerHTML =
    ProjectListManager.getProjectList()[
      selectedProjectIndex
    ].getProjectComplete() === false
  ...
  const editProject = (e) => {
    ...
    editTaskContainerDescriptionInput.value =
      ProjectListManager.getProjectList()[
        selectedProjectIndex
      ].getProjectDescription();
    ...
    editTaskContainerDateInput.value =
      ProjectListManager.getProjectList()[
        selectedProjectIndex
      ].getProjectDate();
    ...
    editTaskContainerPriorityInput.value =
      ProjectListManager.getProjectList()[
        selectedProjectIndex
      ].getProjectPriority();
    ...
    const editTask = (e) => {
      ...
      ProjectListManager.getProjectList()[selectedProjectIndex].editProjectName(
        nameInput
      );
      ProjectListManager.getProjectList()[
        selectedProjectIndex
      ].editProjectDescription(descriptionInput);
      ProjectListManager.getProjectList()[selectedProjectIndex].editProjectDate(
        dateInput
      );
      ProjectListManager.getProjectList()[
        selectedProjectIndex
      ].editProjectPriority(priorityInput);
  ...
  let completeTaskButton = document.querySelector(
    "#projects-container-complete"
  );
  ...
  let taskArray =
    ProjectListManager.getProjectList()[selectedProjectIndex].getProjectTasks();
  for (let i = 0; i < taskArray.length; i++) {
    ...
    if (
      ProjectListManager.getProjectList()
        [selectedProjectIndex].getProjectTasks()
        [i].getTaskComplete() === true
    ) {
      taskName.style =
        "text-decoration: line-through; color: rgba(255, 255, 255, 0.343);";
    }
  ...
  const completeTaskFromProject = (e) => {
    ...
    if (
      ProjectListManager.getProjectList()
        [selectedProjectIndex].getProjectTasks()
        [taskId].getTaskComplete() === true
    ) {
      ProjectListManager.getProjectList()
        [selectedProjectIndex].getProjectTasks()
        [taskId].setTaskComplete(false);
    } else {
      ProjectListManager.getProjectList()
        [selectedProjectIndex].getProjectTasks()
        [taskId].setTaskComplete(true);
    }
  ...
  const deleteTaskFromProject = (e) => {
    ...
    ProjectListManager.getProjectList()[selectedProjectIndex].deleteProjectTask(
      taskId
    );
  ...
  const editTaskFromProject = (e) => {
    ...
    let taskName = ProjectListManager.getProjectList()
      [selectedProjectIndex].getProjectTasks()
      [taskId].getTaskName();
    ...
    editTaskContainerNameInput.setAttribute("required", "required");
    editTaskContainerNameInput.type = "text";
    editTaskContainerNameInput.value = ProjectListManager.getProjectList()
      [selectedProjectIndex].getProjectTasks()
      [taskId].getTaskName();
    editTaskContainerName.appendChild(editTaskContainerNameInput);
    editTaskBody.appendChild(editTaskContainerName);
    ...
    editTaskContainerDateInput.setAttribute("required", "required");
    editTaskContainerDateInput.type = "date";
    editTaskContainerDateInput.value = ProjectListManager.getProjectList()
      [selectedProjectIndex].getProjectTasks()
      [taskId].getTaskDate();
    editTaskContainerDate.appendChild(editTaskContainerDateInput);
    editTaskContainerDate.id = "add-task-container-date";
    ...
    editTaskContainerPriority.appendChild(editTaskContainerPriorityInput);
    editTaskContainerPriorityInput.value = ProjectListManager.getProjectList()
      [selectedProjectIndex].getProjectTasks()
    ...
    const editTask = (e) => {
      ...
      ProjectListManager.getProjectList()
        [selectedProjectIndex].getProjectTasks()
        [taskId].editTaskName(nameInput);
      ProjectListManager.getProjectList()
        [selectedProjectIndex].getProjectTasks()
        [taskId].editTaskDescription(descriptionInput);
      ProjectListManager.getProjectList()
        [selectedProjectIndex].getProjectTasks()
        [taskId].editTaskDate(dateInput);
      ProjectListManager.getProjectList()
        [selectedProjectIndex].getProjectTasks()
        [taskId].editTaskPriority(priorityInput);
      // remove add task modal
      greyout.remove();
      GeneralTask();
    };
  ...
  if (ProjectListManager.getProjectList().length > 1) {
    for (let i = 1; i < ProjectListManager.getProjectList().length; i++) {
      ...
      projectRow.textContent =
        ProjectListManager.getProjectList()[i].getProjectName();
